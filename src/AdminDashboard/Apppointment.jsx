  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col w-full space-y-4 sm:space-y-4 md:space-y-0 md:flex-row md:justify-between md:items-center mb-6">
          {/* Search and Filter - Full width on mobile, auto width on md+ */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center w-full md:w-auto space-y-3 sm:space-y-0">
            ...
            <button className="flex items-center bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg sm:ml-3 w-full sm:w-auto justify-center sm:justify-start">
          ...
          <div className="flex items-center w-full md:w-auto justify-between sm:justify-end space-x-3">
            <button className="flex items-center bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg">
              <Download className="mr-2 h-5 w-5 sm:h-5 sm:w-5" />
